...
void set_adc(uint8_t MD, uint8_t DCP, uint8_t CH, uint8_t CHG); // ����ADC״̬

void LTC6804_adcv(void); // ������ص�ѹADCת������ѯ״̬

void LTC6804_adax(void); // ����GPIO ADCת������ѯ״̬

uint8_t LTC6804_rdcv(uint8_t reg, uint8_t total_ic, uint16_t cell_codes[][12]); // ��ȡ��ص�ѹ

void LTC6804_rdcv_reg(uint8_t reg, uint8_t nIC, uint8_t *data);

int8_t LTC6804_rdaux(uint8_t reg, uint8_t nIC, uint16_t aux_codes[][6]); // ��ȡ�����Ĵ���

void LTC6804_rdaux_reg(uint8_t reg, uint8_t nIC, uint8_t *data);

void LTC6804_clrcell(void); // �����ص�ѹ�Ĵ���A��B��C ��D��

void LTC6804_clraux(void); // ��������Ĵ��� A �� B

void LTC6804_wrcfg(uint8_t nIC, uint8_t config[][6]); // д���üĴ���

int8_t LTC6804_rdcfg(uint8_t nIC, uint8_t r_config[][8]); // �����üĴ���

void delayMicroseconds(unsigned int x);

void wakeup_idle(void); // ���ź����void�����򱨾�
...
void LTC6804_cvst(void); // �Բ���ģʽ

void LTC6804_ADSTAT(void); // ����״̬��ADCת�����˲�ģʽ

int8_t LTC6804_rdstat(uint8_t reg, uint8_t total_ic, uint16_t stat_codes[][6]); // ��״̬�Ĵ���

void LTC6804_rdstat_reg(uint8_t reg, uint8_t total_ic, uint8_t *data);

void LTC6804_adcvax(void); // ������ϵ�ص�ѹ�Լ�GPIO1��GPIO2ת������ѯ״̬
#endif
